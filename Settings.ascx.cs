...
namespace DotNetNuke.Modules.DNN_AjaxControlToolkit
{
    ...
    /// 
    /// Because the control inherits from DNN_AjaxControlToolkitSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : DNN_AjaxControlToolkitModuleSettingsBase
    {
