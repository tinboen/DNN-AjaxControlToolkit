...
namespace DotNetNuke.Modules.DNN_AjaxControlToolkit.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.DNN_AjaxControlToolkit.Data.SqlDataprovider,DNN_AjaxControlToolkit";
